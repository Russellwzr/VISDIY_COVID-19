...
var series = [];
[
    ["上海",BJData],["陕西",BJData],["甘肃",BJData],["四川",BJData],["辽宁",BJData],
    ["广东",BJData],["云南",BJData],["天津",BJData]
...
let option = {
   // backgroundColor: '#1B2631',
    tooltip: {
        ...
        formatter: function(params, ticket, callback) {
            if (params.seriesType == "effectScatter") {
                ...
                return params.data.fromName + " ---> " + params.data.toName + "<br />" + params.data.datetime;
            } else {
                return params.name;
            }
        },
    ...
    title: {
        ...
        subtext: "06-27 ---> 07-06", //'数据来源：国家及各省市地区卫健委',
